      ...
      <div className="flex flex-col-reverse md:flex-row items-center h-screen">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="border p-8 md:p14 bg-white rounded shadow w-fit">
            ...
            <Textfield label="Nama Lengkap" other="my-3" />
            <Textfield label="Username" other="my-3" />
            <Textfield label="Nomor Hp" type="number" other="my-3" />
            <Textfield label="Password" other="my-3" type="Password" />
            <Button child="Daftar" other="w-full mt-3" />
            <p className="text-sm text-center mt-5">
              Sudah Punya Akun ?{" "}
              <span onClick={() => router.push("/login")} className="cursor-pointer text-teal-800 font-semibold">
                Masuk
              </span>
            </p>
          </div>
